#!/bin/bash
# tyc-financial-services Installation Script · 一键安装 / Installation
#
# 用法 / Usage:
#   curl 模式（推荐） / curl mode (recommended):
#     bash <(curl -sL https://raw.githubusercontent.com/tyc-tech/tyc-financial-services/main/install_tyc_mcp.sh)
#
#   本地模式 / local mode:
...
REPO_NAME="tyc-financial-services"
REPO_OWNER="tyc-tech"
...
echo "  天眼查 OpenAPI MCP · 投资 / 金融服务 23 SKILL"
echo "=========================================="
echo ""
