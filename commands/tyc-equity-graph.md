...
description: equity-graph
argument-hint: "<企业名称或统一社会信用代码>"
---

# /tyc-equity-graph · equity-graph

本命令由 SKILL 文件定义，详见：[`../skills/equity-graph/SKILL.md`](../skills/equity-graph/SKILL.md)

## 快速使用

```
/tyc-equity-graph <searchKey>
```
