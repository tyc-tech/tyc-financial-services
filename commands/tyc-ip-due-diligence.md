...
description: ip-due-diligence
argument-hint: "<企业名称或统一社会信用代码>"
---

# /tyc-ip-due-diligence · ip-due-diligence

本命令由 SKILL 文件定义，详见：[`../skills/ip-due-diligence/SKILL.md`](../skills/ip-due-diligence/SKILL.md)

## 快速使用

```
/tyc-ip-due-diligence <searchKey>
```
