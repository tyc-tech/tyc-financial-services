...
description: bankruptcy-monitor
argument-hint: "<企业名称或统一社会信用代码>"
---

# /tyc-bankruptcy-monitor · bankruptcy-monitor

本命令由 SKILL 文件定义，详见：[`../skills/bankruptcy-monitor/SKILL.md`](../skills/bankruptcy-monitor/SKILL.md)

## 快速使用

```
/tyc-bankruptcy-monitor <searchKey>
```
