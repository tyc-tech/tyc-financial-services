...
description: park-research
argument-hint: "<企业名称或统一社会信用代码>"
---

# /tyc-park-research · park-research

本命令由 SKILL 文件定义，详见：[`../skills/park-research/SKILL.md`](../skills/park-research/SKILL.md)

## 快速使用

```
/tyc-park-research <searchKey>
```
