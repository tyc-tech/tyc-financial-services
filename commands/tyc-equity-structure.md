...
# /tyc-equity-structure · equity-structure

本命令由 SKILL 文件定义，详见：[`../skills/equity-structure/SKILL.md`](../skills/equity-structure/SKILL.md)

## 快速使用

```
/tyc-equity-structure <searchKey>
```
