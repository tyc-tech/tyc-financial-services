...
description: pf-compliance
argument-hint: "<企业名称或统一社会信用代码>"
---

# /tyc-pf-compliance · pf-compliance

本命令由 SKILL 文件定义，详见：[`../skills/pf-compliance/SKILL.md`](../skills/pf-compliance/SKILL.md)

## 快速使用

```
/tyc-pf-compliance <searchKey>
```
