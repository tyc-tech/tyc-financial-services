...
description: dd-checklist
argument-hint: "<企业名称或统一社会信用代码>"
---

# /tyc-dd-checklist · dd-checklist

本命令由 SKILL 文件定义，详见：[`../skills/dd-checklist/SKILL.md`](../skills/dd-checklist/SKILL.md)

## 快速使用

```
/tyc-dd-checklist <searchKey>
```
