...
description: litigation-analysis
argument-hint: "<企业名称或统一社会信用代码>"
---

# /tyc-litigation-analysis · litigation-analysis

本命令由 SKILL 文件定义，详见：[`../skills/litigation-analysis/SKILL.md`](../skills/litigation-analysis/SKILL.md)

## 快速使用

```
/tyc-litigation-analysis <searchKey>
```
